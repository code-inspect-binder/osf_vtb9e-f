Sim.Dyad.Model.13 = function(N.dyad,T.obs,  
...
Y.F = c.F + a.FF*data.X[,'X.F.c'] + a.FF2*I(data.X[,'X.F.c']^2) + p.MF*data.X[,'X.M.c'] + p.MF2*I(data.X[,'X.M.c']^2) + b.F*data.X[,'W.dyad.c'] + b.FF*data.X[,'X.F.c']*data.X[,'W.dyad.c'] + b.FF2*I(data.X[,'X.F.c']^2)*data.X[,'W.dyad.c'] + b.MF*data.X[,'X.M.c']*data.X[,'W.dyad.c'] + b.MF2*I(data.X[,'X.M.c']^2)*data.X[,'W.dyad.c'] + V[,'V.F'] + E[,'E.F']

Y.M = c.M + a.MM*data.X[,'X.M.c'] + a.MM2*I(data.X[,'X.M.c']^2) + p.FM*data.X[,'X.F.c'] + p.FM2*I(data.X[,'X.F.c']^2) + b.M*data.X[,'W.dyad.c'] + b.MM*data.X[,'X.M.c']*data.X[,'W.dyad.c'] + b.MM2*I(data.X[,'X.M.c']^2)*data.X[,'W.dyad.c'] + b.FM*data.X[,'X.F.c']*data.X[,'W.dyad.c'] + b.FM2*I(data.X[,'X.F.c']^2)*data.X[,'W.dyad.c'] + V[,'V.M'] + E[,'E.M']
}
...
mutate(X.F.c = X.F - mean(X.F),
       X.M.c = X.M - mean(X.M))
# Simulate Dependent Variables
Y.F = c.F + a.FF*data.X[,'X.F.c'] + a.FF2*I(data.X[,'X.F.c']^2) + p.MF*data.X[,'X.M.c'] + p.MF2*I(data.X[,'X.M.c']^2) + b.F*data.X[,'W.dyad'] + b.FF*data.X[,'X.F.c']*data.X[,'W.dyad'] + b.FF2*I(data.X[,'X.F.c']^2)*data.X[,'W.dyad'] + b.MF*data.X[,'X.M.c']*data.X[,'W.dyad'] + b.MF2*I(data.X[,'X.M.c']^2)*data.X[,'W.dyad'] + V[,'V.F'] + E[,'E.F']

Y.M = c.M + a.MM*data.X[,'X.M.c'] + a.MM2*I(data.X[,'X.M.c']^2) + p.FM*data.X[,'X.F.c'] + p.FM2*I(data.X[,'X.F.c']^2) + b.M*data.X[,'W.dyad'] + b.MM*data.X[,'X.M.c']*data.X[,'W.dyad'] + b.MM2*I(data.X[,'X.M.c']^2)*data.X[,'W.dyad'] + b.FM*data.X[,'X.F.c']*data.X[,'W.dyad'] + b.FM2*I(data.X[,'X.F.c']^2)*data.X[,'W.dyad'] + V[,'V.M'] + E[,'E.M'] 
}}  
...
# Simulate Dependent Variables
Y.F = c.F + a.FF*data.X[,'X.F'] + a.FF2*I(data.X[,'X.F']^2) + p.MF*data.X[,'X.M'] + p.MF2*I(data.X[,'X.M']^2) + b.F*data.X[,'W.dyad.c'] + b.FF*data.X[,'X.F']*data.X[,'W.dyad.c'] + b.FF2*I(data.X[,'X.F']^2)*data.X[,'W.dyad.c'] + b.MF*data.X[,'X.M']*data.X[,'W.dyad.c'] + b.MF2*I(data.X[,'X.M']^2)*data.X[,'W.dyad.c'] + V[,'V.F'] + E[,'E.F']

Y.M = c.M + a.MM*data.X[,'X.M'] + a.MM2*I(data.X[,'X.M']^2) + p.FM*data.X[,'X.F'] + p.FM2*I(data.X[,'X.F']^2) + b.M*data.X[,'W.dyad.c'] + b.MM*data.X[,'X.M']*data.X[,'W.dyad.c'] + b.MM2*I(data.X[,'X.M']^2)*data.X[,'W.dyad.c'] + b.FM*data.X[,'X.F']*data.X[,'W.dyad.c'] + b.FM2*I(data.X[,'X.F']^2)*data.X[,'W.dyad.c'] + V[,'V.M'] + E[,'E.M']
}
if(is.center.W==FALSE){
# Simulate Dependent Variables
Y.F = c.F + a.FF*data.X[,'X.F'] + a.FF2*I(data.X[,'X.F']^2) + p.MF*data.X[,'X.M'] + p.MF2*I(data.X[,'X.M']^2) + b.F*data.X[,'W.dyad'] + b.FF*data.X[,'X.F']*data.X[,'W.dyad'] + b.FF2*I(data.X[,'X.F']^2)*data.X[,'W.dyad'] + b.MF*data.X[,'X.M']*data.X[,'W.dyad'] + b.MF2*I(data.X[,'X.M']^2)*data.X[,'W.dyad'] + V[,'V.F'] + E[,'E.F']

Y.M = c.M + a.MM*data.X[,'X.M'] + a.MM2*I(data.X[,'X.M']^2) + p.FM*data.X[,'X.F'] + p.FM2*I(data.X[,'X.F']^2) + b.M*data.X[,'W.dyad'] + b.MM*data.X[,'X.M']*data.X[,'W.dyad'] + b.MM2*I(data.X[,'X.M']^2)*data.X[,'W.dyad'] + b.FM*data.X[,'X.F']*data.X[,'W.dyad'] + b.FM2*I(data.X[,'X.F']^2)*data.X[,'W.dyad'] + V[,'V.M'] + E[,'E.M']
}}
