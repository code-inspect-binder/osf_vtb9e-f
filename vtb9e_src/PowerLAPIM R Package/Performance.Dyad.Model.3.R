Performance.Dyad.Model.3 = function(N0.dyad,N1.dyad,T.obs,  
...
if (is.REML==TRUE){
fit.Model.3 = lme(fixed = Y ~ -1 + Female + Female.Z + Female:X.Actor + Female:X.Actor.Z + Female:X.Partner + Female:X.Partner.Z + Male + Male.Z + Male:X.Actor + Male:X.Actor.Z + Male:X.Partner + Male:X.Partner.Z,
...
# Bias
bias = coef(summary(fit.Model.3))[,1] - c(c.F0,c.F1,c.M0,c.M1,a.FF0,a.FF1,p.MF0,p.MF1,a.MM0,a.MM1,p.FM0,p.FM1)
...
CI.width = CI[,3] - CI[,1]
CR = CI[,1] < c(c.F0,c.F1,c.M0,c.M1,a.FF0,a.FF1,p.MF0,p.MF1,a.MM0,a.MM1,p.FM0,p.FM1) & CI[,3] > c(c.F0,c.F1,c.M0,c.M1,a.FF0,a.FF1,p.MF0,p.MF1,a.MM0,a.MM1,p.FM0,p.FM1)
