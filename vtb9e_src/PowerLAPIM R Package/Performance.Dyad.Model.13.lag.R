Performance.Dyad.Model.13.lag = function(N.dyad,T.obs,  
...
# Bias
bias = coef(summary(fit.Model.13))[,1] - c(c.F,c.M,rho.YF,a.FF,a.FF2,p.MF,p.MF2,b.F,b.FF,b.FF2,b.MF,b.MF2,rho.YM,
...
CI.width = CI[,3] - CI[,1]
CR = CI[,1] < c(c.F,c.M,rho.YF,a.FF,a.FF2,p.MF,p.MF2,b.F,b.FF,b.FF2,b.MF,b.MF2,rho.YM,
a.MM,a.MM2,p.FM,p.FM2,b.M,b.MM,b.MM2,b.FM,b.FM2) & CI[,3] > c(c.F,c.M,rho.YF,a.FF,a.FF2,p.MF,p.MF2,b.F,b.FF,b.FF2,b.MF,b.MF2,rho.YM,
a.MM,a.MM2,p.FM,p.FM2,b.M,b.MM,b.MM2,b.FM,b.FM2)
