Sim.Dyad.Model.8.lag = function(N.dyad,T.obs,  
...
if (is.center.X == TRUE){
# Initialized values
Y.F[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.F.c'] + p*data.X[T.obs.i[1],'X.M.c'] + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.F.c']*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.M.c']*data.X[T.obs.i[1],'D.dyad'] + V[T.obs.i[1]] + E[T.obs.i[1],'E.F']

Y.M[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.M.c'] + p*data.X[T.obs.i[1],'X.F.c'] + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.M.c']*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.F.c']*data.X[T.obs.i[1],'D.dyad'] + V[T.obs.i[1]] + E[T.obs.i[1],'E.M']

for (t in T.obs.i[-1]){
# Simulate Dependent Variables
Y.F[t] = c + rho.Y*Y.F[t-1] + a*data.X[t,'X.F.c'] + p*data.X[t,'X.M.c'] +  d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.F.c']*data.X[t,'D.dyad'] + d.p*data.X[t,'X.M.c']*data.X[t,'D.dyad'] + V[t] + E[t,'E.F']

Y.M[t] = c + rho.Y*Y.M[t-1] + a*data.X[t,'X.M.c'] + p*data.X[t,'X.F.c'] + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.M.c']*data.X[t,'D.dyad'] + d.p*data.X[t,'X.F.c']*data.X[t,'D.dyad'] + V[t] + E[t,'E.M']
}}

if (is.center.X == FALSE){
# Initialized values
Y.F[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.F'] + p*data.X[T.obs.i[1],'X.M'] + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.F']*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.M']*data.X[T.obs.i[1],'D.dyad'] + V[T.obs.i[1]] + E[T.obs.i[1],'E.F']

Y.M[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.M'] + p*data.X[T.obs.i[1],'X.F'] + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.M']*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.F']*data.X[T.obs.i[1],'D.dyad'] + V[T.obs.i[1]] + E[T.obs.i[1],'E.M']

for (t in T.obs.i[-1]){
# Simulate Dependent Variables
Y.F[t] = c + rho.Y*Y.F[t-1] + a*data.X[t,'X.F'] + p*data.X[t,'X.M'] + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.F']*data.X[t,'D.dyad'] + d.p*data.X[t,'X.M']*data.X[t,'D.dyad'] + V[t] + E[t,'E.F']

Y.M[t] = c + rho.Y*Y.M[t-1] + a*data.X[t,'X.M'] + p*data.X[t,'X.F'] + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.M']*data.X[t,'D.dyad'] + d.p*data.X[t,'X.F']*data.X[t,'D.dyad'] + V[t] + E[t,'E.M']
}}}
