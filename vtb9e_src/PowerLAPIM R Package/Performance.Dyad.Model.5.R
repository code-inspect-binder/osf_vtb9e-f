Performance.Dyad.Model.5 = function(N.dyad,T.obs,  
...
if (is.REML==TRUE){
fit.Model.5 = lme(fixed = Y ~ -1 + Female + Female:X.Actor + Female:X.Partner +
                  Female:W + Female:X.Actor.W + Female:X.Partner.W + Male + 
...
# Bias
bias = coef(summary(fit.Model.5))[,1] - c(c.F,c.M,a.FF,p.MF,b.F,b.FF,b.MF,a.MM,p.FM,b.M,b.MM,b.FM)
...
CI.width = CI[,3] - CI[,1]
CR = CI[,1] < c(c.F,c.M,a.FF,p.MF,b.F,b.FF,b.MF,a.MM,p.FM,b.M,b.MM,b.FM) & CI[,3] > c(c.F,c.M,a.FF,p.MF,b.F,b.FF,b.MF,a.MM,p.FM,b.M,b.MM,b.FM)
