Performance.Dyad.Model.4.lag = function(N0.dyad,N1.dyad,T.obs,  
...
if (is.REML==TRUE){
fit.Model.4 = lme(fixed = Y ~ 1 + Z + Y.lag + Y.lag.Z +
                  X.Actor + X.Actor.Z + X.Partner + X.Partner.Z,
...
# Bias
bias = coef(summary(fit.Model.4))[,1] - c(c0,c1,rho.Y0,rho.Y1,a0,a1,p0,p1)
...
CI.width = CI[,3] - CI[,1]
CR = CI[,1] < c(c0,c1,rho.Y0,rho.Y1,a0,a1,p0,p1) & CI[,3] > c(c0,c1,rho.Y0,rho.Y1,a0,a1,p0,p1)
