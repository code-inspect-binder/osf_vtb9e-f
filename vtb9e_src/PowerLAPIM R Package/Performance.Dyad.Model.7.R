Performance.Dyad.Model.7 = function(N.dyad,T.obs,  
...
if (is.REML==TRUE){
fit.Model.7 = lme(fixed = Y ~ -1 + Female + Female:X.Actor + Female:X.Partner + Female:D                   
                  + Female:X.Actor.D + Female:X.Partner.D + Male + 
...
# Bias
bias = coef(summary(fit.Model.7))[,1] - c(c.F,c.M,a.FF,p.MF,d.F,d.FF,d.MF,a.MM,p.FM,d.M,d.MM,d.FM)
...
CI.width = CI[,3] - CI[,1]
CR = CI[,1] < c(c.F,c.M,a.FF,p.MF,d.F,d.FF,d.MF,a.MM,p.FM,d.M,d.MM,d.FM) & CI[,3] > c(c.F,c.M,a.FF,p.MF,d.F,d.FF,d.MF,a.MM,p.FM,d.M,d.MM,d.FM)
