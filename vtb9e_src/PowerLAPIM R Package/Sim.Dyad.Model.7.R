Sim.Dyad.Model.7 = function(N.dyad,T.obs,  
...
Y.F = c.F + a.FF*data.X[,'X.F.c'] + p.MF*data.X[,'X.M.c'] + d.F*data.X[,'D.dyad'] + d.FF*data.X[,'X.F.c']*data.X[,'D.dyad'] + d.MF*data.X[,'X.M.c']*data.X[,'D.dyad'] + V[,'V.F'] + E[,'E.F']

Y.M = c.M + a.MM*data.X[,'X.M.c'] + p.FM*data.X[,'X.F.c'] + d.M*data.X[,'D.dyad'] + d.MM*data.X[,'X.M.c']*data.X[,'D.dyad'] + d.FM*data.X[,'X.F.c']*data.X[,'D.dyad'] + V[,'V.M'] + E[,'E.M']
}

if(is.center.X==FALSE){
# Simulate Dependent Variables
Y.F = c.F + a.FF*data.X[,'X.F'] + p.MF*data.X[,'X.M'] + d.F*data.X[,'D.dyad'] + d.FF*data.X[,'X.F']*data.X[,'D.dyad'] + d.MF*data.X[,'X.M']*data.X[,'D.dyad'] + V[,'V.F'] + E[,'E.F']

Y.M = c.M + a.MM*data.X[,'X.M'] + p.FM*data.X[,'X.F'] + d.M*data.X[,'D.dyad'] + d.MM*data.X[,'X.M']*data.X[,'D.dyad'] + d.FM*data.X[,'X.F']*data.X[,'D.dyad'] + V[,'V.M'] + E[,'E.M']
}
