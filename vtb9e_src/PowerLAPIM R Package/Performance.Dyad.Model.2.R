Performance.Dyad.Model.2 = function(N.dyad,T.obs,  
c,a,p,
...
if (is.REML==TRUE){
fit.Model.2 = lme(fixed = Y ~ 1 + X.Actor + X.Partner,
...
# Bias
bias = coef(summary(fit.Model.2))[,1] - c(c,a,p)
