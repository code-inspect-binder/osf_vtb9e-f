Sim.Dyad.Model.16.lag = function(N.dyad,T.obs,  
...
X.F = data.X[,'X.F']
X.M = data.X[,'X.M']
D.dyad = rbinom(N.dyad*T.total,1,prob.D)
...
if (is.center.X == TRUE){
# Initialized values
Y.F[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.F.c'] + a.2*I(data.X[T.obs.i[1],'X.F.c']^2) + p*data.X[T.obs.i[1],'X.M.c'] + p.2*I(data.X[T.obs.i[1],'X.M.c']^2) + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.F.c']*data.X[T.obs.i[1],'D.dyad'] + d.a2*I(data.X[T.obs.i[1],'X.F.c']^2)*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.M.c']*data.X[T.obs.i[1],'D.dyad'] + d.p2*I(data.X[T.obs.i[1],'X.M.c']^2)*data.X[T.obs.i[1],'D.dyad'] +  V[T.obs.i[1]] + E[T.obs.i[1],'E.F']

Y.M[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.M.c'] + a.2*I(data.X[T.obs.i[1],'X.M.c']^2) + p*data.X[T.obs.i[1],'X.F.c'] + p.2*I(data.X[T.obs.i[1],'X.F.c']^2) + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.M.c']*data.X[T.obs.i[1],'D.dyad'] + d.a2*I(data.X[T.obs.i[1],'X.M.c']^2)*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.F.c']*data.X[T.obs.i[1],'D.dyad'] + d.p2*I(data.X[T.obs.i[1],'X.F.c']^2)*data.X[T.obs.i[1],'D.dyad'] +  V[T.obs.i[1]] + E[T.obs.i[1],'E.M']

for (t in T.obs.i[-1]){
# Simulate Dependent Variables
Y.F[t] = c + rho.Y*Y.F[t-1] + a*data.X[t,'X.F.c'] + a.2*I(data.X[t,'X.F.c']^2) + p*data.X[t,'X.M.c'] + p.2*I(data.X[t,'X.M.c']^2) + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.F.c']*data.X[t,'D.dyad'] + d.a2*I(data.X[t,'X.F.c']^2)*data.X[t,'D.dyad'] + d.p*data.X[t,'X.M.c']*data.X[t,'D.dyad'] + d.p2*I(data.X[t,'X.M.c']^2)*data.X[t,'D.dyad'] +  V[t] + E[t,'E.F']

Y.M[t] = c + rho.Y*Y.M[t-1] + a*data.X[t,'X.M.c'] + a.2*I(data.X[t,'X.M.c']^2) + p*data.X[t,'X.F.c'] + p.2*I(data.X[t,'X.F.c']^2) + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.M.c']*data.X[t,'D.dyad'] + d.a2*I(data.X[t,'X.M.c']^2)*data.X[t,'D.dyad'] + d.p*data.X[t,'X.F.c']*data.X[t,'D.dyad'] + d.p2*I(data.X[t,'X.F.c']^2)*data.X[t,'D.dyad'] +  V[t] + E[t,'E.M']
}}

if (is.center.X == FALSE){
# Initialized values
Y.F[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.F'] + a.2*I(data.X[T.obs.i[1],'X.F']^2) + p*data.X[T.obs.i[1],'X.M'] + p.2*I(data.X[T.obs.i[1],'X.M']^2) + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.F']*data.X[T.obs.i[1],'D.dyad'] + d.a2*I(data.X[T.obs.i[1],'X.F']^2)*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.M']*data.X[T.obs.i[1],'D.dyad'] + d.p2*I(data.X[T.obs.i[1],'X.M']^2)*data.X[T.obs.i[1],'D.dyad'] +  V[T.obs.i[1]] + E[T.obs.i[1],'E.F']

Y.M[T.obs.i[1]] = c + a*data.X[T.obs.i[1],'X.M'] + a.2*I(data.X[T.obs.i[1],'X.M']^2) + p*data.X[T.obs.i[1],'X.F'] + p.2*I(data.X[T.obs.i[1],'X.F']^2) + d*data.X[T.obs.i[1],'D.dyad'] + d.a*data.X[T.obs.i[1],'X.M']*data.X[T.obs.i[1],'D.dyad'] + d.a2*I(data.X[T.obs.i[1],'X.M']^2)*data.X[T.obs.i[1],'D.dyad'] + d.p*data.X[T.obs.i[1],'X.F']*data.X[T.obs.i[1],'D.dyad'] + d.p2*I(data.X[T.obs.i[1],'X.F']^2)*data.X[T.obs.i[1],'D.dyad'] +  V[T.obs.i[1]] + E[T.obs.i[1],'E.M']

for (t in T.obs.i[-1]){
# Simulate Dependent Variables
Y.F[t] = c + rho.Y*Y.F[t-1] + a*data.X[t,'X.F'] + a.2*I(data.X[t,'X.F']^2) + p*data.X[t,'X.M'] + p.2*I(data.X[t,'X.M']^2) + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.F']*data.X[t,'D.dyad'] + d.a2*I(data.X[t,'X.F']^2)*data.X[t,'D.dyad'] + d.p*data.X[t,'X.M']*data.X[t,'D.dyad'] + d.p2*I(data.X[t,'X.M']^2)*data.X[t,'D.dyad'] +  V[t] + E[t,'E.F']

Y.M[t] = c + rho.Y*Y.M[t-1] + a*data.X[t,'X.M'] + a.2*I(data.X[t,'X.M']^2) + p*data.X[t,'X.F'] + p.2*I(data.X[t,'X.F']^2) + d*data.X[t,'D.dyad'] + d.a*data.X[t,'X.M']*data.X[t,'D.dyad'] + d.a2*I(data.X[t,'X.M']^2)*data.X[t,'D.dyad'] + d.p*data.X[t,'X.F']*data.X[t,'D.dyad'] + d.p2*I(data.X[t,'X.F']^2)*data.X[t,'D.dyad'] +  V[t] + E[t,'E.M']
}}}
...
D.dyad = as.matrix(data.X[,'D.dyad']) 
